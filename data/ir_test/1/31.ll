; ModuleID = '/scratch/talbn/classifyapp_code/test/1/31.txt.cpp'
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31.txt.cpp, i8* null }]
...
entry:
  ...
  %call = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %m)
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call i32 @_Z4calcii(i32 2, i32 %1)
  store i32 %call2, i32* %ans, align 4
  %2 = load i32, i32* %ans, align 4
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %2)
  br label %while.cond
...
; Function Attrs: uwtable
define i32 @_Z4calcii(i32 %p, i32 %t) #2 {
entry:
...
if.then:                                          ; preds = %for.body
  ...
  %div = sdiv i32 %7, %8
  %call2 = call i32 @_Z4calcii(i32 %6, i32 %div)
...
define internal void @_GLOBAL__sub_I_31.txt.cpp() #0 section ".text.startup" {
entry:
