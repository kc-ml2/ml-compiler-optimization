...
class GNN(nn.Module):
    def __init__(self, node_dim, edge_dim, out_dim=32):
        ...
        self.convs = nn.ModuleList([
            pygnn.GATv2Conv(node_dim, 128, edge_dim=edge_dim, heads=3),
            pygnn.GATv2Conv(128, 128, edge_dim=edge_dim, heads=3),
            pygnn.GATv2Conv(128, out_dim, edge_dim=edge_dim, heads=3),
        ])
