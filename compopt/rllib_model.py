...
#         super().__init__()
#         self.c1 = pygnn.GATv2Conv(node_dim, 512, edge_dim=edge_dim)
#         self.c2 = pygnn.GATv2Conv(512, 512, edge_dim=edge_dim)
#         self.c3 = pygnn.GATv2Conv(512, 256, edge_dim=edge_dim)
#         self.c4 = pygnn.GATv2Conv(256, out_dim, edge_dim=edge_dim)
#         self.out_dim = out_dim
#
#     def forward(self, x, edge_index, edge_attr):
#         x = self.c1(x, edge_index, edge_attr)
#         x = self.c2(x, edge_index, edge_attr)
#         x = self.c3(x, edge_index, edge_attr)
#         x = self.c4(x, edge_index, edge_attr)
