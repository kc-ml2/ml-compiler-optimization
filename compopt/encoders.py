...
class PositionEmbedding(nn.Module):
    ...
    def forward(
        ...
        # replace OOV TODO : cpu - gpu maybe bottleneck, preprocess on cpu instead
...
class GNN(nn.Module):
    def __init__(self, node_dim, edge_dim, out_dim=32):
        ...
        self.convs = nn.ModuleList([
            pygnn.GATv2Conv(node_dim, 32, edge_dim=edge_dim, heads=2),
            pygnn.GATv2Conv(64, out_dim, edge_dim=edge_dim),
        ])
